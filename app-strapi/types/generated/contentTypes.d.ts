...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ContactLinks: Schema.Attribute.Component<'shared.logo-and-links', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTALinks: Schema.Attribute.Component<'shared.logo-and-links', true>;
    HeaderLogo: Schema.Attribute.Component<'shared.logo-and-links', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
    > &
      Schema.Attribute.Private;
    MenuItems: Schema.Attribute.Component<'shared.menu-items', true>;
